const Banner = () => {
    return (
        <div className="bg-[url('/BannerBG.svg')] bg-no-repeat bg-center text-center px-4 lg:px-64 py-20 lg:py-32 mt-4 lg:mt-10 rounded-2xl flex flex-col items-center justify-center">
